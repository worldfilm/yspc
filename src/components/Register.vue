      ...
      <form role="form" id="signUpForm" novalidate="novalidate">
        ...
        <p class="sure">
          <label for="over18" style="font-weight:normal">
                <input @click='checkd' v-model='chose'  class="form-check-input" name="over18" type="checkbox"style="margin-right: 8px;" data-content="请接受此协议">我已阅读并同意本网站的策略，隐私声明、<a >条款及协议</a>
          </label>
        </p>
        <div class="form-group">
